...
exports.globalSearch = async (req, res) => {
  ...
  try {
    ...
    }).select('jobTitle company.location company.logo company.name'); 
    ...
    .select('jobTitle description experienceLevel location skills user')
    ...
    }).select('title description location date company.logo'); 
